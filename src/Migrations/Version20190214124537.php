 ...
 */
final class Version20190214124537 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comment (id_comment INT AUTO_INCREMENT NOT NULL, id_client INT NOT NULL, id_product INT NOT NULL, date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, title VARCHAR(100) NOT NULL, content VARCHAR(1000) DEFAULT NULL, INDEX FK_comment_idClient (id_client), INDEX FK_comment_idProduct (id_product), PRIMARY KEY(id_comment)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product (id_product INT AUTO_INCREMENT NOT NULL, id_category INT DEFAULT NULL, product_title VARCHAR(100) NOT NULL, unit_price_HT DOUBLE PRECISION NOT NULL, reference VARCHAR(100) NOT NULL, quantity INT NOT NULL, description VARCHAR(1000) NOT NULL, UNIQUE INDEX UNIQ_D34A04ADAEA34913 (reference), INDEX FK_product_idCategory (id_category), PRIMARY KEY(id_product)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE category (id_category INT AUTO_INCREMENT NOT NULL, title_category TINYTEXT NOT NULL, name_category VARCHAR(100) NOT NULL, PRIMARY KEY(id_category)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product_picture (id_product_picture INT AUTO_INCREMENT NOT NULL, id_product INT NOT NULL, picture_name VARCHAR(100) NOT NULL, updated_at DATETIME NOT NULL, INDEX FK_productPicture_idProduct (id_product), UNIQUE INDEX FK_productPicture_picture (picture_name), PRIMARY KEY(id_product_picture)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tax (id_tax INT AUTO_INCREMENT NOT NULL, tax NUMERIC(10, 2) NOT NULL, PRIMARY KEY(id_tax)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE opinion (id_opinion INT AUTO_INCREMENT NOT NULL, id_client INT DEFAULT NULL, id_product INT NOT NULL, date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, score INT NOT NULL, INDEX FK_opinion_idClient (id_client), INDEX FK_opinion_idProduct (id_product), PRIMARY KEY(id_opinion)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE command (id_command INT AUTO_INCREMENT NOT NULL, id_address_delivery INT DEFAULT NULL, id_client INT DEFAULT NULL, date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, total_HT NUMERIC(15, 2) NOT NULL, shipping NUMERIC(15, 2) NOT NULL, tax_on_command NUMERIC(30, 2) NOT NULL, INDEX FK_command_idClient (id_client), INDEX FK_command_idAddressDelivery (id_address_delivery), PRIMARY KEY(id_command)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE client (id_client INT AUTO_INCREMENT NOT NULL, id_default_address INT DEFAULT NULL, login VARCHAR(20) NOT NULL, email VARCHAR(100) NOT NULL, password VARCHAR(250) NOT NULL, last_name VARCHAR(50) DEFAULT NULL, first_name VARCHAR(50) DEFAULT NULL, phone_number VARCHAR(13) DEFAULT NULL, avatar_url VARCHAR(2000) DEFAULT NULL, creation_date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, confirmed TINYINT(1) NOT NULL, token VARCHAR(40) NOT NULL, roles VARCHAR(255) NOT NULL, INDEX FK_client_idDefaultAddress (id_default_address), PRIMARY KEY(id_client)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE comment ADD CONSTRAINT FK_9474526CE173B1B8 FOREIGN KEY (id_client) REFERENCES client (id_client) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE comment ADD CONSTRAINT FK_9474526CDD7ADDD FOREIGN KEY (id_product) REFERENCES product (id_product) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE address ADD CONSTRAINT FK_D4E6F81E173B1B8 FOREIGN KEY (id_client) REFERENCES client (id_client) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04AD5697F554 FOREIGN KEY (id_category) REFERENCES category (id_category) ON DELETE SET NULL');
